...
- [Git当中的常规操作有哪些以及他们的不同之处？](#Git当中的常规操作有哪些以及他们的不同之处)
- [请说说你对虚拟DOM的理解？](#请说说你对虚拟DOM的理解)
- [节流/防抖/函数柯里化在实际工程中有什么作用并且简述下其原理?](#节流/防抖/函数柯里化在实际工程中有什么作用并且简述下其原理)
...
## Git当中的常规操作有哪些以及他们的不同之处?
git reset/rebase/revert/merge/fetch的区别是什么
